...
class FourSquareSpider(scrapy.Spider):
	...
	def parse(self, response):
		try:
			name = response.css('#container > div > div.contents > div.wideColumn > div.venueInfoSection > div.venueHeader > div.primaryInfo > div.venueNameSection > h1::text')[0].extract()
